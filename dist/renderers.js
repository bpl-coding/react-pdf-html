...
const renderers = {
    ...
    li: ({ element, stylesheets, style, children }) => {
        ...
        return (react_1.default.createElement(renderer_1.View, { style: style },
            bullet && react_1.default.createElement(renderer_1.View, { wrap: false, style: bulletStyles }, bullet),
            react_1.default.createElement(renderer_1.View, { wrap: false, style: contentStyles }, children)));
    },
